...
S_0=35
T_melt=λ1*S_0+λ2
initial_temperature(z) = (273+T_melt) -  T_melt*0.5*(1.0-erf(25.0*(z+0.25))) #273-1.7*exp(-z^2/(0.1^2)) #+log10(40*z^2+1e-0)
...
simulation.output_writers[:temperature] =
    JLD2OutputWriter(model, model.tracers,
                     filename = "one_dimensional_diffusionTS_iceocean_1024.jld2",
...
filename = "one_dimensional_diffusionTS_iceocean_1024"
